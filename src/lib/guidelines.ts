// 保育所保育指針・幼稚園教育要領・認定こども園教育保育要領から抽出した
// 年齢別・領域別のねらい・内容の構造化データ
...
export const GUIDELINES: Record<string, AgeGuideline> = {
  "0歳児": {
    label: "乳児保育（0歳児）",
    ...
    domains: {
      ...
      "身近な人と気持ちが通じ合う": {
        goals: [
          ...
          "身近な人と親しみの関わりを深め、愛情や信頼感が芽生える",
        ],
        content: [
          "子どもからの働きかけを踏まえた、応答的な触れ合いや言葉がけを受けて、欲求が満たされ安定感をもって過ごす",
          "体の動きや表情、発声、喃語等を優しく受け止めてもらい、保育士等とのやり取りを楽しむ",
          "保育士等による語りかけや歌いかけ、発声や喃語等への応答を通じて、言葉の理解や発語の意欲が育つ",
          "親しみをもった保育士等との触れ合いの中で、自分を肯定する気持ちが芽生える",
        ],
      },
      "身近なものと関わり感性が育つ": {
        goals: [
          ...
          "身体の諸感覚による認識が豊かになり、表情や手指、体の動き等で表現する",
        ],
        content: [
          ...
          "保育士等のあやし遊びに機謙よく応じたり、歌やリズムに合わせて手足や体を動かして楽しんだりする",
        ],
      },
    },
  },
    ...
    domains: {
      ...
      "環境": {
        ...
        content: [
          ...
          "身の回りの物に触れる中で、形、色、大きさ、量などの物の性質や仕組みに気付き、環境を捉える感覚が育つ",
          "身近な生き物に気付き、親しみをもつ",
      ...
      "表現": {
        ...
        content: [
          ...
          "生活の中で様々な音、形、色、手触り、動き、味、香りなどに気付き、感じたりして楽しむ",
  ...
  "2歳児": {
    ...
    domains: {
      "健康": {
        ...
        content: [
          "走る、跳ぶ、登る、押す、引っ張るなど全身を使う遊びを楽しむ",
          "排泄の自立に向けて、一人一人の発達に合わせた対応をする",
          "食事や午睡、遊びと休息のリズムが形成される",
          "スプーンやフォークを使い、自分で食べようとする意欲が育つ",
          "衣類の着脱を自分でしようとする意欲が高まる",
          "保育士等の助けを借りながら、身の回りを清潔にすることの心地よさを感じる",
          "安全な環境の中で、体を十分に動かして遊ぶ楽しさを感じる",
        ],
      },
      "人間関係": {
        goals: [
        ...
        content: [
          "自我が育つ中で「自分で」という気持ちを尊重しつつ、保育士等が適切に援助する",
          "友達との関わりの中で、物の取り合いなどのトラブルを経験しながら、少しずつ相手の気持ちに気付く",
          "保育士等の仲立ちにより、順番を待つ、交代するなどの経験をする",
          "身近な大人や友達の模倣をしながら、社会的なルールの芽生えが見られる",
          "「いや」「自分で」という自己主張を受け止めてもらう経験を通して、自分の気持ちを調整する力の基礎が育つ",
        ],
      },
      "環境": {
        goals: [
        ...
        content: [
          "戸外で身近な草花や虫などの自然に触れ、興味や関心をもつ",
          "色水遊びや砂場遊びなどを通して、物の性質に気付く",
          "ままごとやブロックなどを通して、見立てやつもり遊びを楽しむ",
          "身の回りの物の名前や数に関心をもち始める",
          "季節の変化や自然の事象に気付き、興味をもつ",
        ],
      },
      "言葉": {
        goals: [
        ...
        content: [
          "二語文・三語文が増え、自分の思いを言葉で表現しようとする",
          "保育士等との会話を楽しみ、言葉のやり取りが活発になる",
          "絵本や紙芝居のストーリーに興味をもち、繰り返し見たり聞いたりすることを楽しむ",
          "日常生活の中で「ありがとう」「ごめんね」などの言葉を使い始める",
          "「なぜ」「どうして」と質問することが増える",
          "自分の名前や身近な物の名前を言えるようになる",
        ],
      },
      "表現": {
        goals: [
        ...
        content: [
          "クレヨンや絵の具などを使い、描くことを楽しむ",
          "歌や手遊び、リズム遊びを楽しむ",
          "見立て遊びやごっこ遊びの中で、自分なりのイメージを表現する",
          "粘土や砂、水などの感触を楽しみ、様々な素材に触れる",
          "保育士等と一緒に歌ったり踊ったりすることを楽しむ",
        ],
      },
    },
  },
    ...
    domains: {
      ...
      "人間関係": {
        ...
        content: [
          ...
          "友達と楽しく活動する中で、共通の目的を見出し、工夫したり、協力したりする",
      ...
      "言葉": {
        ...
        content: [
          ...
          "したこと、見たこと、聞いたこと、味わったこと、感じたこと、考えたことなどを自分なりに言葉で表現する",
...
export const AGE4_FEATURES = [
  "友達関係が深まり、特定の友達と遊ぶことが増える",
  "自己主張が強くなるとともに、相手の気持ちに気づき始める",
  "想像力が豊かになり、ごっこ遊びが複雑になる",
  "「なぜ」「どうして」の質問が増え、因果関係への関心が高まる",
  "基本的生活習慣がほぼ自立する",
  "集団のルールを理解し、守ろうとする意識が芽生える",
];

export function getGuidelineText(age: string): string {
...
export const AGE_OPTIONS = ["0歳児", "1歳児", "2歳児", "3歳児", "4歳児", "5歳児"];
export const MONTH_OPTIONS = ["4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月", "1月", "2月", "3月"];
